...
export default function Footer() {
    return (
        <div className="flex flex-col gap-2 place-items-center py-4 text-sm border-t border-t-gray-400">
            <div className="flex flex-row gap-4 place-items-center">
                ...
                <div className="flex flex-row gap-2 place-items-center">
                    ...
                    <a className="hover:underline" href="https://instagram.com/umanitobacssa">@umanitobacssa</a>
                </div>
                <div className="flex flex-row gap-2 place-items-center">
                    <BsFillEnvelopeFill className="w-8 h-8"/>
                    <a className="hover:underline" href="mailto:cssa@umanitoba.ca">cssa@umanitoba.ca</a>
                </div>
                <div className="flex flex-row gap-2 place-items-center">
                    <FaGithub className="w-8 h-8"/>
                    <a className="hover:underline" href="https://github.com/umanitoba-cssa/">@umanitoba-cssa</a>
                </div>
            </div>
            <div className="flex flex-row gap-4 place-items-center">
