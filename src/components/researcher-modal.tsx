        ...
        <AnimatePresence onExitComplete={handleExitComplete}>
            {!isExiting && (
                ...
                >
                    ...
                    >   
                    <div className="z-10 bg-blue-800 sticky top-0 flex justify-end items-center px-4 py-3">
                        <button
                            onClick={handleClose}
                                    ...
                                    <div className="flex flex-col md:flex-row lg:flex-col lg:gap-1 md:gap-4 md:items-start">
                                        ...
                                        <div className="my-3 md:my-0 lg:my-3">
                                            <div className="mt-3 md:mt-0 lg:mt-3">
                                                <p className="text-lg font-bold">{researcher.fullName}</p>
                                                {researcher.lab?.name && <p className="text-sm">{researcher.lab?.name}</p>}
                                            </div>
                                            <div className="mt-4">
                                                {
