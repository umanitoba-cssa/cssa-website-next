...
export const ResourceLinks: IResourceLink[] = [
    {
        ...
        description:
            'Information about the Science Co-op program and contact information for the Co-op coordinators.',
    ...
    },
    {
        ...
        description:
            'Schedule an appointment with an academic advisor to ask your program-related questions.',
...
export const CSSALinks: IResourceLink[] = [
    ...
    },
    {
        ...
        description:
            'The old guide to your first year at the UofM as a First Year. See Guides for the updated version.',
        href: 'docs/firstYearGuide.pdf',
    },
    {
        title: 'Researchers',
        description:
            'Collection of UofM researchers and labs, their interests, criteria, and contact information',
    ...
    {
        title: 'CS Discord Moderator Handbook',
        description: 'The moderator handbook of the Computer Science Lounge Discord.',
        href: '/docs/discordModHandbook.pdf',
    },
    {
        title: 'CS Discord Copyright Policy',
        description:
            'The policy on sharing copyrighted materials in the Computer Science Lounge Discord',
        href: '/docs/discordCopyrightPolicy.pdf',
    },
    {
