...
export const RecentEvents: Map<string, IEventLink> = new Map([
    ...
    ["capture-the-flag-2025", {
        ...
        description: 'Compete with a team in cybersecurity challenges with the theme "Murder Mystery"',
    ...
    ["goosies-2024", {
        title: 'Goosies 2024',
        description: 'Annual award show for the Department of Computer Science',
