            ...
            <div className="container py-12 flex flex-col gap-12">
                ...
                */}
                ...
                <p>Please register by joining our <a className="underline" href="https://discord.umanitobacssa.ca/gamejam">discord</a> and following the instructions in <i>#welcome</i> <br />
                    <br />
                    Teams are recommended to be a team of 4 participants (not everyone needs to be a coder). 6 team members maximum. All users should register on the discord. Only <b>ONE</b> user needs to submit their project to this page. You may also register solo.<br />
                    <br />
