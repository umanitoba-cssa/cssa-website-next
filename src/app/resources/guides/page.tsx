    ...
    <main className="flex flex-col">
      ...
      <div className="container py-8 flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          ...
          <p>
            The CSSA has compiled a collection of guides to help computer science students
            navigate their academic journey and prepare for their careers. These guides cover
