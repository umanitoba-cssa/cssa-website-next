        ...
        <main className="flex flex-col">
            ...
            <div className="container py-12 flex flex-col items-center gap-6 text-center">
                ...
                <p className="text-muted-foreground max-w-xl">
                    The section "{params['section-slug']}" in the guide "{guide.title}" could not be
                    found. It might have been removed or had its name changed.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 mt-4">
                    <Button
                        ...
                        asChild
                    >
                        <Link href={`/resources/guides/${params['guide-slug']}`}>View Guide</Link>
                    </Button>
                    <Button
                        variant="outline"
