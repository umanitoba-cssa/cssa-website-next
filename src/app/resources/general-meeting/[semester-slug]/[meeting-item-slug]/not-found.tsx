...
export default async function SectionNotFound({ 
  ...
  if (!params || !params['semester-slug']) {
    notFound();
  }

  // Check if the guide exists
  const guide = await getGuideBySlug(params['semester-slug']);
    ...
    <main className="flex flex-col">
      ...
      <div className="container py-12 flex flex-col items-center gap-6 text-center">
        ...
        <p className="text-muted-foreground max-w-xl">
          The section "{params['meeting-item-slug']}" in the guide "{guide.title}" could not be found. It might have been removed or had its name changed.
        </p>
