        ...
        <main className="flex flex-col">
            ...
            <div className="container py-8 flex flex-col gap-8">
                <div className="flex flex-col gap-4">
                    ...
                    <p>
                        The CSSA has compiled a collection of general meeting archives to help
                        computer science students navigate their academic journey and prepare for
                        their careers. These archives cover a range of topics from getting started
                        with computer science to finding internships and jobs.
                    </p>
                </div>
